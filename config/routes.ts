...
export default [
  ...
  // },
  {
    ...
    layout: false,
    routes: [
      { path: '/detail/:id', component: './home/basic/Detail' },
      {
        name: 'center',
        icon: 'smile',
        path: '',
      ...
      },
      {
        name: 'center',
        icon: 'smile',
        path: '/gioi-thieu/hoi-cay-ghep-nha-khoa',
        component: './home/introduction/DentalImplantSociety',
      },
      {
        name: 'center',
        icon: 'smile',
        path: '/gioi-thieu/ban-chap-hanh',
        component: './home/introduction/ExecutiveCommittee',
      },
      {
        name: 'center',
        icon: 'smile',
        path: '/gioi-thieu/dieu-le-hoi',
        component: './home/introduction/AssociationBylaws',
      },
      {
        name: 'center',
        icon: 'smile',
        path: '/gioi-thieu/phuong-huong-hoat-dong',
        component: './home/introduction/ActivityDirections',
      },
      {
        name: 'center',
        icon: 'smile',
